...
class SortedCheckboxSelectMultiple(forms.CheckboxSelectMultiple):
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        rendered_choices = [(o.id, '{} {}'.format(o.admin_thumbnail(), o) if hasattr(o, 'admin_thumbnail') else str(o)) for o in self.choices.queryset]

        for i, (option_value, option_label) in enumerate(chain(rendered_choices, choices)):
