...
(function ($) {
    $(function () {
        $('.sortedm2m-select-all').click(function (event) {
            event.preventDefault();
            console.log($(this).closest('.sortedm2m-items').length);
            $(this).parent('p').prev('.sortedm2m-items').find('input.sortedm2m').prop( "checked", true);
        });
        $('.sortedm2m-deselect-all').click(function (event) {
            event.preventDefault();
            console.log($(this).closest('.sortedm2m-items').length);
            $(this).parent('p').prev('.sortedm2m-items').find('input.sortedm2m').prop( "checked", false);
        });
